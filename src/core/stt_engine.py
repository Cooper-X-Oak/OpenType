...
class STTEngine:
    def __init__(self, api_key=None):
        ...
        # Use paraformer-realtime-v2 for better accuracy and speed (newer generation)
        # Reverted from paraformer-v1 which caused ModelNotFound error in Recognition class
